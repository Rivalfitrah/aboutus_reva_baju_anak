            ...
            <div className="text-center">
                ...
                <div className="max-w-6xl mx-auto flex flex-col md:flex-row md:justify-between gap-6">
                    ...
                    <div className="flex-1">
                        <div className="mb-4">                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1725.46374714693!2d107.14218176542572!3d-6.826744747865306!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e685253f1426fcb%3A0x1163ab5c10f9ab61!2sRevaBajuAnak!5e0!3m2!1sen!2sid!4v1746173995842!5m2!1sen!2sid" 
                width="600" height="300" style={{border:0}} allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
                    ...
                    <div className="flex-1">
                        ...
                        <p className="text-sm mb-6">Dapatkan update terbaru tentang koleksi dan promo dari Reva Baju Anak melalui media sosial kami:</p>                        <div className="flex gap-6 items-center">
                            <a href="https://instagram.com" target="_blank" className="flex items-center gap-2 hover:text-pink-500 transition">
                            <Instagram className="w-5 h-5" />
                            <span>@revabajuanak</span>
                            </a>
                            <br/>
                            <a href="https://tiktok.com" target="_blank" className="flex items-center gap-2 hover:text-black transition">
